...
.footer img {
  height: 35px;
  width: 35px;
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,iBAAiB;AACnB;;AAEA;EACE,YAAY;EACZ,sBAAsB;EACtB,oCAAoC;EACpC,2BAA2B;EAC3B,iBAAiB;AACnB;;;;AAIA;EACE,SAAS;EACT,UAAU;EACV,WAAW;EACX,aAAa;EACb,gBAAgB;EAChB,yDAAuE;EACvE,4BAA4B;EAC5B,sBAAsB;AACxB;;AAEA;EACE,iBAAiB;EACjB,WAAW;EACX,aAAa;EACb,aAAa;EACb,sBAAsB;EACtB,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;AACrB;;AAEA;EACE,mCAAmC;AACrC;;AAEA;EACE,UAAU;EACV,YAAY;EACZ,+CAA+C;EAC/C,gBAAgB;AAClB;;AAEA;EACE,UAAU;EACV,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;AACrB;;AAEA;EACE,UAAU;EACV,eAAe;AACjB;;AAEA;;AAEA;;AAEA;EACE,eAAe;EACf,qCAAqC;AACvC;;AAEA;EACE,mBAAmB;EACnB,mCAAmC;AACrC;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,eAAe;EACf,mCAAmC;AACrC;;AAEA;EACE,gBAAgB;EAChB,aAAa;EACb,SAAS;AACX;;AAEA;EACE,WAAW;EACX,4CAA4C;EAC5C,mBAAmB;AACrB;;AAEA;;EAEE,SAAS;AACX;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,SAAS;AACX;;AAEA;;EAEE,mCAAmC;AACrC;;;AAGA;EACE,kBAAkB;EAClB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,eAAe;EACf,SAAS;AACX;;AAEA;EACE,YAAY;EACZ,WAAW;AACb","sourcesContent":[":root {\n  --font-size: 20px;\n}\n\n* {\n  color: white;\n  box-sizing: border-box;\n  font-family: 'Noto Sans', sans-serif;\n  font-size: var(--font-size);\n  font-weight: bold;\n}\n\n\n\nhtml, body {\n  margin: 0;\n  padding: 0;\n  width: 100%;\n  height: 100vh;\n  overflow: hidden;\n  background-image: url(./assets/images/pexels-philippe-donn-1169754.jpg);\n  background-repeat: no-repeat;\n  background-size: cover;\n}\n\n.container {\n  padding: 5vh 10vw;\n  width: 100%;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n\n.header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.title {\n  font-size: calc(var(--font-size)*2);\n}\n\n.header form input {\n  all: unset;\n  cursor: text;\n  border-bottom: solid rgba(255, 255, 255, 0.582);\n  padding: 0px 5px;\n}\n\n.header form button {\n  all: unset;\n  cursor: pointer;\n}\n\n.header button img{\n  width: 40px;\n  height: 40px;\n}\n\n.content {\n  display: flex;\n  justify-content: space-evenly;\n  align-items: center;\n}\n\n.arrow {\n  all: unset;\n  cursor: pointer;\n}\n\n.current {\n  \n}\n\n.description {\n  grid-area: desc;\n  font-size: calc(var(--font-size)*1.5);\n}\n\n.location {\n  grid-area: location;\n  font-size: calc(var(--font-size)*3);\n}\n\n.date {\n  grid-area: date;\n}\n\n.current-temp {\n  grid-area: temp;\n  font-size: calc(var(--font-size)*6);\n}\n\n.weather-details {\n  margin-top: 15px;\n  display: flex;\n  gap: 30px;\n}\n\n.weather-details:before {\n  content: \"\";\n  border: 1px solid rgba(255, 255, 255, 0.582);\n  align-self: stretch;\n}\n\n.current-temp,\n.left-side-details {\n  order: -1;\n}\n\n.right-side-details {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  gap: 10px;\n}\n\n.left-side-details .high-temp,\n.left-side-details .low-temp {\n  font-size: calc(var(--font-size)*4);\n}\n\n\n.footer {\n  text-align: center;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-wrap: wrap;\n  gap: 15px;\n}\n\n.footer img {\n  height: 35px;\n  width: 35px;\n}"],"sourceRoot":""}]);
// Exports
